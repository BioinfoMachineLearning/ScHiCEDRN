...
from Models.Hiedsr_ganT48 import Generator, Discriminator  # note the import should be carefull
...
class hiedsr(object):
    def __init__(self, Gan = True, epoch = 250, batch_s = 1, cellN = 1, percentage = 0.75):
        ...
        self.cell_line = 'HumanT48_'  #note: test here should pay attention
        self.cell_no = cellN
...
if __name__ == "__main__":
    train_model = hiedsr(Gan = False, epoch = 400, batch_s = 1, cellN = 1, percentage = 0.75)
