...
class GeneratorLoss(nn.Module):
    def __init__(self):
        ...
        loss_network = nn.Sequential(*list(vgg.features)[:31]).eval()  # because the whole vgg16 model  has 31 nodes
    ...
    def forward(self, out_labels, out_images, target_images):
        ...
        total = image_loss + 0.001 * perception_loss + 2e-8 * tv_loss + 2e-3 * adversarial_loss
